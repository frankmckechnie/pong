...
function init() {
  ...
  for (var i = 0; i < 100; i++) {
    var radius = _utils__WEBPACK_IMPORTED_MODULE_0___default.a.randomIntFromRange(20, 40);
...
function animate() {
  ...
  c.fillText('yolo', mouse.x, mouse.y); // data.innerHTML = 'dy: ' + ball.dy + '<br> y:' + ball.y + '<br>x:' + ball.x ;
